<html>
  ...
  <body>
    ...
    <br />
    A list of cars at the selected station will be displayed on a new page that is formatted for printing.<br />
    <br />
    ...
    <?php
      ...
      print drop_down_stations("station_name", "");
